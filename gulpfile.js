...
gulp.task('watch-files', function() {
    ...
    gulp.watch([miscSrcDir+'*',miscSrcDir+'**/*',miscSrcDir+'**/*.pug',miscSrcDir + ".*"], ['move-files']);
});
...
gulp.task('build-views', function() {
    gulp.src([viewsSrcDir + '*.pug',viewsSrcDir + '/*/*.pug'])
        .pipe(pug({
            "pretty": true
        }))
...
// Default Task
gulp.task('default', ['compile-sass-autoprefixed-minified', 'watch-files', 'build-js', 'build-views','move-files']);
